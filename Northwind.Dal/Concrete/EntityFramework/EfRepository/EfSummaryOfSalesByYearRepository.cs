...
{
    public class EfSummaryOfSalesByYearRepository : EfGenericRepository<SummaryOfSalesByYear>, ISummaryOfSalesByYearRepository
    {
        public EfSummaryOfSalesByYearRepository(DbContext context) : base(context)
        {
        }
