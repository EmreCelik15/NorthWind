...
{
    public class EfEmployeeTerritoryRepository : EfGenericRepository<EmployeeTerritory>, IEmployeeTerritoryRepository
    {
        public EfEmployeeTerritoryRepository(DbContext context) : base(context)
        {
        }
