...
{
    public class EfProductsByCategoryRepository : EfGenericRepository<ProductsByCategory>, IProductsByCategoryRepository
    {
        public EfProductsByCategoryRepository(DbContext context) : base(context)
        {
        }
