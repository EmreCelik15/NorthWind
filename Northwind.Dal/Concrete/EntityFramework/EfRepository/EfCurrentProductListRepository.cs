...
{
    public class EfCurrentProductListRepository : EfGenericRepository<CurrentProductList>, ICurrentProductListRepository
    {
        public EfCurrentProductListRepository(DbContext context) : base(context)
        {
        }
