...
{
    public class EfOrderSubtotalRepository : EfGenericRepository<OrderSubtotal>, IOrderSubtotalRepository
    {
        public EfOrderSubtotalRepository(DbContext context) : base(context)
        {
        }
