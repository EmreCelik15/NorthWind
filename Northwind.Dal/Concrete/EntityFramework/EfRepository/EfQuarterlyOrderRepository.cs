...
{
    public class EfQuarterlyOrderRepository : EfGenericRepository<QuarterlyOrder>, IQuarterlyOrderRepository
    {
        public EfQuarterlyOrderRepository(DbContext context) : base(context)
        {
        }
