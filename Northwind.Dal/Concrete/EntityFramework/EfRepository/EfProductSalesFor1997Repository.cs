...
{
    public class EfProductSalesFor1997Repository:EfGenericRepository<ProductSalesFor1997>, IProductSalesFor1997Repository
    {
        public EfProductSalesFor1997Repository(DbContext context) : base(context)
    {
    }
