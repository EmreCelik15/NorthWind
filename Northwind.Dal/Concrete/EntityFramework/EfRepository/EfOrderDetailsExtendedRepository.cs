...
{
    public class EfOrderDetailsExtendedRepository : EfGenericRepository<OrderDetailsExtended>, IOrderDetailsExtendedRepository
    {
        public EfOrderDetailsExtendedRepository(DbContext context) : base(context)
        {
        }
